//  IMPORTS for Three.js library, 
//      OrbitControls (movement around the environment), 
//          FontLoader/TextGeo for 3D text
...
// 3 things are absolutely necessary for any Three.js scene:
//      a scene (environment where meshes are added)
//          a camera (the view of the environment)
//              and a renderer (displays the environment in the browser)
...
//  this grabs the width and height of the browser viewport
//      and sizes the environment accordingly
renderer.setPixelRatio(window.devicePixelRatio);
renderer.setSize(window.innerWidth, window.innerHeight);

// attaches the renderer to the browser
document.body.appendChild(renderer.domElement);

// allows us to import images to map onto meshes
//      i.e. make a sphere look like Earth
...
fontLoader.load('./fonts/cabin-regular.json', (font) => {
    console.log('font is loaded');
    const textGeometry = new TextGeometry('Yeeeahhh boyyeee', {
        font: font,
        size: 3,
        height: 0.8,
        curveSegments: 12,
